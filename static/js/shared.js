...
function buildNavbar(activePage) {
  ...
  var html = '<header class="navbar">'
    ...
    + '</button>'
    + '<a href="' + ROUTES.index + '" class="navbar-logo"><img src="/static/img/logo.svg" alt="uzshop">uz<span>shop</span></a>'
    ...
    + '<span style="display:inline-flex;align-items:center;gap:8px;font-family:var(--font-mono);font-weight:600;font-size:18px"><img src="/static/img/logo.svg" alt="" style="width:26px;height:26px;display:block">uz<span style="color:var(--accent)">shop</span></span>'
